    ...
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Register(User model)
        {
            if (ModelState.IsValid)
            {
                ...
                var newUser = new User { Username = model.Username, Email = model.Email, Password = Helper.ToMD5(model.Password) };  // Ensure you hash the password before saving to the database
